...
- 1116 байт * 10 * 876.91 млрд (кол-во постов) = 9 786 315.6 Гб = 9786 Тб (Записи comments)
- 8 байт * 10 * 876.91 млрд (кол-во постов) = 70152.8 Гб = 70 Тб (Записи в comments_posts)
- 1112 байт * 876.91 млрд (кол-во постов) = 975 123.92 Гб = 975 Тб (Записи в posts)

Итог: 975 Тб + 70 Тб + 9786 Тб + 7 Тб + 141 Гб + 25 Гб + 2 Гб + 8 Гб = 10 778.176 Тб

| CPU(cores) | RAM(GB) | SSD(GB) |
|------------|---------|---------|
|   4       | 16      | 4096    |

Выходит что наши 215 серверов (не считая slave) должны в итоге хранить такой объем данных.
