...
Прирост еженедельный: 854 / 336 = 2.54 на одного юзера/группу

Количество постов: 2.54 * 62млн * (30 дней * 12 месяцев *  14 лет ) *  0.5 (учитываем кол-во уников в году)  =  397 110 000 000 = 397.11 млрд постов

Один пост в среднем = 100kb картинка + 500kb комментарии с картинками = 600kb

397.11 млрд * 600 kb = 238 266 kb * 10^9 = 238 266 Тб
