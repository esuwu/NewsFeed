...
Выходит что наших 215 серверов (не считая slave) недостаточно. Если один сервер имеет память 4096 Тб, то нам понадобится 762 сервера, не считая slaves. Вместе со slaves получится 1524 сервера.
