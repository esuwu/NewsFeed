...
- 62млн пользователей * 124 байта  = ... (Записи в users обо всех пользователях)
- 75млн групп * 24 байта = ... (Записи в groups обо всех группах) 
- 62млн пользователей * 50 (в стольких группах в среднем состоит пользователь) * 8 байт = ... (Записи в group_users)
- 62млн пользователей * 286 (столько в среднем друзей у пользователя) *  8 байт  = ... (Записи во friends)
- 8 байт = ... (Записи в user_posts)
- 8 байт = ... (Записи в group_posts) 
- 1116 байт = ... (Записи comments)
- 8 байт = ... (Записи в comments_posts)
- 1112 байт = ... (Записи в posts)
Nginx:
